...
public class ProvideFeedbackPage extends WebBasePage {
	...
	public ProvideFeedbackPage(WebDriver driver) {
		super(driver, "Provide Feedback Page");
	...
	public void clickPerformanceReview() {
		...
		findElementInVisibility(By.xpath("//ul[@class='submenu clschild_14 d-flex']//a[@data-original-title='Review']"),
				20);
		click(By.xpath("//ul[@class='submenu clschild_14 d-flex']//a[@data-original-title='Review']"),
				"Provide Feedback", 20);
	}
